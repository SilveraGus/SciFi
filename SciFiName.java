...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        // generate a sciFi name
        System.out.println("the good stuffs:");
        String name = (firstName.substring(0, 3) + lastName.substring(0, 2));
        String lname =(city.substring(0, 2) + school.substring(0, 3));
        //System.out.println(city.substring(0, 2) + school.substring(0, 2));
        double num = Math.random() * (firstName.length()-1) + 1;
        String s1 = (relativeName1.substring((int)num, relativeName1.length()));
        double num2 = Math.random() * (lastName.length()-1) + 1;
        String s2 = (relativeName2.substring((int)num2, relativeName2.length()));
        System.out.println(s1+s2);
        System.out.println("Hello "+ name + " " + lname + " of " + s1 + s2 + ". Welcome!");
